                            ...
                            <div class="form_group">
                                ...
                                <div class="input_wrapper">
                                    <div class="input_info mb6">
                                        <p class="fc_white">
                                            Calon peserta dikenakan fee registrasi sebesar <span class="fc_red fw_bold">Rp
                                                42.000</span>, peserta dapat melakukan proses pembayaran melalui beberapa
                                            opsi :
                                        <ul style="list-style: circle !important" class="ml4 fc_white">
                                            <li>Mandiri <span class="fc_red fw_bold">1120019491013 </span> a.n. Dzakiyya
                                                Nur Fadhila</li>
                                            <li>Ovo/Dana <span class="fc_red fw_bold">081373626361 </span> a.n. Dzakiyya
                                                Nur Fadhila</li>
                                        </ul>
                                        </p>
                                    </div>
