                                ...
                                <div class="form_group fc_white">
                                    <p class="title_font text_h3 mt4 mb2">
                                        ...
                                        {{-- <div class="price_list mt3">
                                            ...
                                            <p class="fc_red title_font mt3">3 Ticket = <span class="fc_white">RP 180.000</span></p>
                                            <p class="fc_red title_font mt3">4 Ticket = <span class="fc_white">RP 240.000</span></p>
                                            <p class="fc_red title_font mt3">5 Ticket = <span class="fc_white">RP 300.000</span></p>
                                        </div> --}}
                                        <div class="price_list mt3">
                                            <p class="fc_blue title_font input_title">Price List - Normal</p>
                                            <p class="fc_red title_font mt3">1 Ticket = <span class="fc_white">RP 70.000</span></p>
                                            <p class="fc_red title_font mt3">2 Ticket = <span class="fc_white">RP 140.000</span></p>
                                            <p class="fc_red title_font mt3">3 Ticket = <span class="fc_white">RP 195.000</span> ( 15k off )</p>
                                            <p class="fc_red title_font mt3">4 Ticket = <span class="fc_white">RP 280.000</span></p>
                                            <p class="fc_red title_font mt3">5 Ticket = <span class="fc_white">RP 310.000</span> ( 40k off )</p>
                                        </div>
