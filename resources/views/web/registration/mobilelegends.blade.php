                ...
                <form action="{{ route('registration.mobile.legends') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="form_container pb2">
                        <div class="form_group">                            
                            ...
                            <p class="body_font text_h4 fc_red mb4">
                            ...
                            <div class="input_wrapper">
                                <div class="input_info mb1">
                                    <p>
                                        ...
                                        <p class="fc_red fw_bold">-> Rp120.000/ 2 Slot</p>
                                        <p class="fc_red fw_bold">-> Rp185.000/ 3 Slot</p>
                                        <p class="fc_red fw_bold">-> Rp200.000/ 4 Slot</p>
                                ...
                                <div class="input_info mb6">
                                    <p>
                                        <p>Apabila ingin mengambil lebih dari <span class="fc_red fw_bold">1 slot</span>, diharapkan untuk menghubungi cp berikut :</p>
                                        <a href="https://wa.me/6283831958417" class="fc_red fw_bold">Chat CP</a>                                      
                                    </p>
                                </div>
                                <div class="input_container focus">
                                    <div class="icon">
