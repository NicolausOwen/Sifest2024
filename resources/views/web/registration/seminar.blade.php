        ...
        <div class="container p_relative py20">
            ...
            <div class="form_wrapper_grid box_lt_rb_side p6" style="max-width: 1000px; margin:auto">
                ...
                <div class="type_navs d-flex content_center py4" id="type_navs">
                    <button class="type_nav px8 {{ $slot['spyware'] == 0 ? "" : "active" }}" data-id="1" {{ $slot['spyware'] == 0 ? "Disabled" : "" }}>
                        Spyware (Regular) {{ $slot['spyware'] == 0 ? "(Pre Sale Sold Out)" : ""}}
                    </button>
                    {{-- <button class="type_nav px8 {{ ($slot['malware'] == 0 ? "" : $slot['spyware']) == 0 ? "active" : "" }}" data-id="2" {{ $slot['malware'] == 0 ? "Disabled" : "" }}>
                        Malware (VIP) {{ $slot['malware'] == 0 ? "(Pre Sale Sold Out)" : ""}}
                    </button> --}}
                </div>

                <div class="type_tabs">
                    <div class="type_tab {{ $slot['spyware'] == 0 ? "" : "active" }}" type-content="1">
                        <form action="{{ route("registration.seminar") }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form_container seminar pb2">
                                <div class="form_group">
                                    ...
                                    <input type="text" name="type" value="Spyware" hidden>
                                ...
                                <div class="form_group fc_white">
                                    <p class="title_font text_h3 mt4 mb2">
                                        ...
                                        <!-- <div class="price_list mt3">
                                            ...
                                            <p class="fc_red title_font mt3">1 Ticket = <span class="fc_white">RP 45.000</span></p>
                                            <p class="fc_red title_font mt3">2 Ticket = <span class="fc_white">RP 90.000</span></p>
                                            <p class="fc_red title_font mt3">3 Ticket = <span class="fc_white">RP 135.000</span></p>
                                            <p class="fc_red title_font mt3">4 Ticket = <span class="fc_white">RP 180.000</span></p>
                                            <p class="fc_red title_font mt3">5 Ticket = <span class="fc_white">RP 225.000</span></p>
                                        </div> -->
                                        <div class="price_list mt3">
                                            <p class="fc_blue title_font input_title">Price List - Normal</p>
                                            <p class="fc_red title_font mt3">1 Ticket = <span class="fc_white">RP 60.000</span></p>
                                            <p class="fc_red title_font mt3">2 Ticket = <span class="fc_white">RP 120.000</span></p>
                                            <p class="fc_red title_font mt3">3 Ticket = <span class="fc_white">RP 165.000</span> <span class="fc_blue"> ( 15k off )</span></p>
                                            <p class="fc_red title_font mt3">4 Ticket = <span class="fc_white">RP 225.000</span></p>
                                            <p class="fc_red title_font mt3">5 Ticket = <span class="fc_white">RP 260.000</span> <span class="fc_blue"> ( 40k off )</span></p>
                                        </div>

                                    <div class="input_wrapper">
                                        <div class="input_info mb6">
                                            <p>
                                                {{-- Calon peserta dikenakan fee registrasi sebesar <span class="fc_red fw_bold">Rp 100.000</span>, --}}
                            ...
                            <div class="btn_container pb4">
                                <button type="submit" class="btn_left form_btn" name="submit_spyware">
                    ...
                    <div class="type_tab {{ ($slot['malware'] == 0 ? "" : $slot['spyware']) == 0 ? "active" : "" }}" type-content="2">
                        <form action="{{ route("registration.seminar") }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form_container seminar pb2">
                                <div class="form_group">
                                    ...
                                    <input type="text" name="type" value="Malware" hidden>
                                    <input type="text" name="metode" value="Online" hidden>
                                    <div class="input_wrapper">
                                        <div class="input_container">
                                            <div class="icon">
                                ...
                                <div class="form_group">
                                    ...
                                    <div class="price_list mt3">
                                        <p class="fc_blue title_font input_title">Price List - Normal</p>
                                        <p class="fc_red title_font mt3">1 Ticket = <span class="fc_white">  RP 85.000</span></p>
                                    </div>
                            ...
                            <div class="btn_container pb4">
                                <button type="submit" class="btn_left form_btn" name="submit_malware">
                                    <i class="btn_left_design"></i>
                                    Register
                                </button>
                            </div>
