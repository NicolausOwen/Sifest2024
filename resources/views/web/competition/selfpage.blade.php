        ...
        <div class="wrapper">
            ...
            <div class="container p_relative py20">
                <div class="title_font text_center my20 t fc_white">
                    ...
                    <p class="fc_bluegly">SIFEST 2024 Competition</p>
                </div>
                    ...
                    <div class="grid_box_right box_rt_lb_side ease2 r">
                        ...
                        <div class="title_in_section text_nm text_design_bot fc_blue">
                            <span class="title_desc">
                                @if ($competition['competition'] === 'EssayCompe')
                                    “Transformasi Pendidikan Melalui Kreativitas dan Teknologi di Era Digital”
                                @elseif ($competition['competition'] === 'DesignPoster')
                                    "IT Innovation Towards for 5.0 Revolution Era"
                                @elseif ($competition['competition'] === 'UIUXDesign')
                                    "Build the Creative Thinking and Innovation by Technology"
                                @elseif ($competition['competition'] === 'EduVideo')
                                    "Harnessing Technology for Education"
                                @elseif ($competition['competition'] === 'Valorant')
                                    "Build Your Strategy, Show Your Sportivity And be A Glory"
                                @elseif ($competition['competition'] === 'MobileLegends')
                                    "Build Your Strategy, Show Your Sportivity And be A Glory"
                                @endif
                            </span>
                        ...
                        <p class="main_content mt6 fc_white">
                            ...
                            @elseif ($competition['competition'] === 'DesignPoster')
                                Lomba Poster Design merupakan salah satu cabang kompetisi bidang akademik pada SIFEST 2024
                                yang diselenggarakan oleh Himpunan Mahasiswa Sistem Informasi Fasilkom Universitas Sriwijaya
                                Palembang yang mengusung tema “ IT Innovation Towards for 5.0 Industrial Revolution Era “.
                                Perlombaan ini bertujuan untuk memberikan wadah bagi para desainer muda untuk menyalurkan
                                ide dan kreativitasnya dalam memberikan informasi yang dikemas dengan menarik. Peserta dalam
                                lomba ini dapat berupa perorangan (individu) maupun tim dengan maksimal anggota tim adalah 2
                                orang. Lomba ini terbuka untuk masyarakat umum namun dibatasi untuk umur diatas 25 tahun.
                            @elseif ($competition['competition'] === 'UIUXDesign')
                            ...
                            @elseif ($competition['competition'] === 'EduVideo')
                                ...
                                SIFEST 2024. Lomba ini bertujuan untuk mendorong kreativitas dalam memanfaatkan teknologi
                ...
                <div class="timeline_container">
                    ...
                    @if ($competition['competition'] === 'EssayCompe')
                        <div class="timeline_item">
                            ...
                            <div class="timeline_date fc_bluegly b">24 September 2024 - 28 Oktober 2024</div>
                        ...
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">29 Oktober - 31 Oktober 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Penjurian</span>
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pengumuman Finalis</span>
                                <p class="text_sm fc_white">Pengumuman finalis Essay Competition bedasarkan hasil penjurian
                                    pada proses seleksi babak pertama.</p>
                            </div>
                        </div>
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                ...
                                <p class="text_sm fc_white">Technical meeting dilakukan sehari sebelum babak final
                                    berlangsung, technical meeting akan dilakukan secara online.</p>
                            </div>
                        </div>
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">4 November 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Final</span>
                        ...
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">12 November 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pengumuman Pemenang</span>
                    ...
                    @elseif ($competition['competition'] === 'DesignPoster')
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">24 September 2024 - 1 November 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pendaftaran & pengumpulan</span>
                                <p class="text_sm fc_white">Bagi para calon peserta yang memiliki minat dalam kompetisi
                        ...
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">2 November - 6 November 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Penjurian</span>
                                <p class="text_sm fc_white">Karya yang telah dikirimkan oleh peserta akan diproses untuk
                    ...
                    @elseif ($competition['competition'] === 'UIUXDesign')
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pengumuman Finalis</span>
                                <p class="text_sm fc_white">Pengumuman finalis kompetisi UI/UX Design bedasarkan hasil
                                    penjurian proposal pada proses seleksi babak pertama.</p>
                            </div>
                        </div>
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                    ...
                    @elseif ($competition['competition'] === 'EduVideo')
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                ...
                                <span class="title_font fc_white">Pendaftaran & Pengumpulan</span>
                                <p class="text_sm fc_white">Bagi para calon peserta yang memiliki minat dalam kompetisi
                                    Educational Video dapat melakukan registrasi pendaftaran dan mengumpulkan karya sebelum
                                    tenggat waktunya habis.</p>
                            </div>
                        </div>
                        <div class="timeline_item">
                    ...
                    @elseif ($competition['competition'] === 'Valorant')
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pendaftaran</span>
                                <p class="text_sm fc_white">Bagi para calon peserta yang memiliki minat dalam kompetisi
                        ...
                        <div class="timeline_item">
                            <div class="timeline_dot"></div>
                            <div class="timeline_date fc_bluegly b">4 November 2024 - 5 November 2024</div>
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Pertandingan</span>
                    ...
                    @elseif ($competition['competition'] === 'MobileLegends')
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                ...
                                <span class="title_font fc_white">Pendaftaran</span>
                                <p class="text_sm fc_white">Bagi para calon peserta yang memiliki minat dalam kompetisi
                                    Mobile Legends dapat melakukan registrasi pendaftaran sebelum tenggat waktunya habis.
                                </p>
                            </div>
                        </div>
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content box_lt_rb_side">
                                <i class="box_lt_rb_side_design"></i>
                                <span class="title_font fc_white">Technical meeting</span>
                                <p class="text_sm fc_white">Technical meeting dilakukan sehari sebelum pertandingan
                                    berlangsung, technical meeting akan dilakukan secara online.</p>
                            </div>
                        </div>
                        <div class="timeline_item">
                    ...
                    <div class="grid_container_40_50">
                        ...
                        <div class="grid_box_right p_unset ease2 r">
                            ...
                            <div class="btn_container">
                                ...
                                @if ($competition['competition'] === 'EssayCompe')
                                    <a href="https://bit.ly/GuideBookCompetition23" target="_blank"
                    ...
                    <div class="grid_box question_box">
                        <div class="card box_rt_lb_side p4 r">
                            ...
                            <div class="card_body text_sm pt2 pl5">
                                Yaps, semua kompetisi dilaksanakan secara online yaa. untuk info lebih lanjut kamu dapat
                                membuka <a href="https://bit.ly/GuideBookCompetition23" target="_blank"
