        ...
        <div class="wrapper">
            <div class="container p_relative py20">
                <div class="title_font text_center index_min">
                    <p class="text_h1 fc_white"><span class="fc_blue">BAZAAR</span> SIFEST 2024</p>
            ...
            <div class="container p_relative py20">
                ...
                <div class="flex_container">
                    <div class="flex_box p2 l">
                        <div class="img_container">
                            <img src="{{ asset('assets/img/icon/bazaar.png') }}" alt="">
                        </div>
                    </div>
                        ...
                        <div class="main_content p6">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="pr1">Sabtu, 14 Oktober 2024</td>
                                    <td class="pr1"><i class="fa-regular fa-clock"></i></td>
                                    <td class="pr1">16.00 WIB</td>
                                </tr>
                                <tr>
                                    <td class="pr1"><i class="fa-regular fa-calendar"></i></td>
                                    <td class="pr1">Minggu, 15 Oktober 2024</td>
                                    <td class="pr1"><i class="fa-regular fa-clock"></i></td>
                                    <td class="pr1">08.00 WIB</td>
                                </tr>
                                <tr>
                                    <td class="pr1"><i class="fa-regular fa-calendar"></i></td>
                                    <td class="pr1">Sabtu, 21 Oktober 2024</td>
                                    <td class="pr1"><i class="fa-regular fa-clock"></i></td>
                                    <td class="pr1">16.00 WIB</td>
                                </tr>
                                <tr>
                                    <td class="pr1"><i class="fa-regular fa-calendar"></i></td>
                                    <td class="pr1">Sabtu, 28 Oktober 2024</td>
                                    <td class="pr1"><i class="fa-regular fa-clock"></i></td>
                                    <td class="pr1">16.00 WIB</td>
                                </tr>
                            </table>
            ...
            <div class="container p_relative py20">
                ...
                <div class="flex_container">
                    <div class="flex_box l box_event">
                        ...
                        <p class="title_font text_h3 text_center fc_white">Halona Bila</p>
                        <a href="https://wa.me/6285609279606" target="_blank" class="fc_bluegly pb3">+62 856-0927-9606 </a>
                    </div>
                </div>
            </div>
