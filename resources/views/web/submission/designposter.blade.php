    ...
    <div class="wrapper">
        ...
        <div class="container p_relative py20">
            <div class="title_font text_center mt20 mb12">
                ...
                <p class="fc_red">Poster Design Competition</p>
            </div>
            <div class="form_wrapper box_lt_rb_side p6">
                ...
                <form action="{{ route("submission.design.poster") }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="input_wrapper">
                                ...
                                <div class="error_msg">
                                    <p class="text_xsm fc_red">
                                        ...
                                        <b>POSTER DESIGN SF23_Nama Peserta/Nama Ketua Tim</b>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($user['submission'])
                        ...
                        <a href="{{ asset('DesignPoster/'.$user['submission']) }}" class="fw_bold fc_red" target="_blank" style="text-decoration: underline !important">{{ $user['submission'] }}</a>
                    @endif
                </form>
            </div>
        </div>
